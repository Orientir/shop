...
#my code
LIQPAY_PUBLIC_KEY = 'i82233879052'
LIQPAY_PRIVATE_KEY = 'vKEvhhYE7s1UGfgNJ8C4Y2Yzu74ImZfKgT6DW4hx'
# end my code
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://my_saleor_users:my_saleor_passwords@localhost:5432/my_saleor_dbs", conn_max_age=600
    )
}
...
CHECKOUT_PAYMENT_GATEWAYS = {
    ...
    LIQPAY: pgettext_lazy("Payment method name", "LiqPay")
}
...
PAYMENT_GATEWAYS = {
    ...
    LIQPAY: {
        "module": "saleor.payment.gateways.liqpay",
        "config": {
            "store_card": False,
            "auto_capture": True,
            "template_path": "order/payment/liqpay.html",
            "connection_params": {
